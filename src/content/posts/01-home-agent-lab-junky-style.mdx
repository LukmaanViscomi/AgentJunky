...
seriesNumber: 1
excerpt: "Spinning up a real local agent lab on a Windows machine, ADK, Vertex AI, and the wiring in between. First real build of the series, mistakes included."
...
<div class="not-prose my-10">
  ...
  <p class="mt-2 text-center text-[11px] text-muted">Original architecture reference, the one this whole build is based on. Tap to view full size.</p>
</div>
